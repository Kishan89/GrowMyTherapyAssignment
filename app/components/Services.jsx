...
export default function Services() {
  return (
    <section className="bg-[#f6f3eb]" id="services">
      {/* Hero Section */}
      <div className="max-w-6xl mx-auto text-center px-4 md:px-8 pt-12">
      ...
      {/* Divider */}
      <div className="mt-16 h-[1px] bg-[#5c3a1e] mx-20" />

      {/* Areas of Focus */}
      <div className="pt-32 px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-lora text-[#383838] mb-28 leading-snug">
            Areas of Focus
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-28 gap-y-36">
            {services.map((service) => (
              <div key={service.title} className="text-center">
                <img
                  src={service.image}
                  alt={service.title}
                  className="w-[370px] h-[370px] mx-auto object-cover rounded-full mb-8 shadow-md"
                />
                <h3 className="text-xl font-lora font-medium text-[#2a2a2a] mb-4">
                  {service.title}
                </h3>
                <p className="text-[#6b6b6b] text-[16px] font-light leading-relaxed max-w-sm mx-auto">
                  {service.description}
                </p>
              </div>
            ))}
      ...
      {/* Rates & Insurance */}
      <div className="bg-[#89a8a9] text-[#1a1a1a] font-lora text-center px-6 py-20 mt-32">
        <h2 className="text-[36px] font-lora font-light mb-10">
          Rates and Insurance
        </h2>
        <div className="text-[17px] font-light leading-relaxed space-y-6">
      ...
      {/* Quote Section */}
      <div
        className="relative w-full bg-cover bg-center text-center px-4 min-h-[520px] flex items-center"
        style={{
